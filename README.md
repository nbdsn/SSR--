...
## 安装 ##
    wget -N --no-check-certificate https://raw.githubusercontent.com/nbdsn/SSR--/master/install.sh && bash install.sh

## 卸载 ##
    wget -N --no-check-certificate https://raw.githubusercontent.com/nbdsn/SSR--/master/uninstall.sh && bash uninstall.sh
    
## 自检 ##
    wget -N --no-check-certificate https://raw.githubusercontent.com/nbdsn/SSR--/master/self-check.sh && bash self-check.sh
